...
let nome = 'Marcelo Antonio Pereira Marcolino';
...
valor1 = parseInt(Math.random() * 100  + 1);
valor2 = parseInt(Math.random() * 100  + 1);
...
if(idade > 17) {
    console.log(`Você que tem ${idade} é maior de idade.`);
} else {
    console.log(`Você que tem ${idade} é menor de idade.`);
}
